...
define build-bootanimation
    sh device/fsl/sabreauto_6q/bootanimation/generate-bootanimation.sh \
    $(TARGET_SCREEN_WIDTH) \
    $(TARGET_SCREEN_HEIGHT)
endef

TARGET_GENERATED_BOOTANIMATION := $(OUT)/obj/BOOTANIMATION/bootanimation.zip
...
LOCAL_MODULE_PATH := $(OUT)/system/media
